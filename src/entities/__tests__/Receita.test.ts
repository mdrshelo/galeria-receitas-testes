...
describe("Receita", () => {
  ...
  it("deve criar instancia a partir de JSON", () => {
    const json = { id: 5, titulo: "Pao", descricao: "Caseiro", tempo: "2h", foto: null };
